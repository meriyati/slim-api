        ...
        <div class="col-lg-4">
            <div class="card shadow-lg border-0">
                <div class="card-header text-center bg-primary text-white">
                    <h1 class="card-title">Tambah Mahasiswa</h1>
                </div>
                <div class="card-body">
                    <!-- Success Message -->
                    ...
                    <form action="{{ route('admin.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="npm" class="form-control" id="npm" placeholder="12345" value="{{ old('npm') }}" required>
                        </div>
                        <div class="mb-3">
            ...
            <div class="text-center mt-3">
                <a href="{{ route('admin.dashboard') }}" class="btn btn-primary">Kembali ke Daftar Mahasiswa</a>
            </div>
        </div>
    </div>
